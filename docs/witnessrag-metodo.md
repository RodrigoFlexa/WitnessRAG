...
Versões em português para leitura, em PDF (fonte LaTeX ao lado):
[witnessrag-explicado.pdf](witnessrag-explicado.pdf) (explicação passo a passo:
testemunha, formulação, memória, percurso da pergunta, da testemunha à
resposta), [paper/witnessrag-metodo-pt.pdf](paper/witnessrag-metodo-pt.pdf)
(tradução didática da seção de método, com o mesmo rigor) e
[paper/witnessrag-proposta-pt.pdf](paper/witnessrag-proposta-pt.pdf)
(desenho enxuto da proposta, no estilo da metodologia do GAM).
