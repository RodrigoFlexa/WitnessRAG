# Resultados — 20260915-044922-315277-qwen-pilot
...
|---|---|---|---|---|---|---|---|---|
| witnessrag | 72.4 | 94.8 | 88.2 | 22.5 | 54.4 | 5.9 | 0 | 9.51 |

IC95% por bootstrap (1000 reamostragens):

| método | R@2 IC95% | R@5 IC95% | AR@5 IC95% | EM IC95% | F1 IC95% |
|---|---|---|---|---|---|
| witnessrag | [64.2, 79.6] | [91.8, 97.2] | [81.4, 94.1] | [14.7, 31.4] | [47.5, 61.6] |
...
| witnessrag | multi-hop | 32 | 37.6 | 9.4 | 40.2 | 12.5 | 83.3 | 62.5 |
...
|---|---|---|---|---|
| witnessrag | 61.1 / 100.0 (n=76) | 34.0 / 63.2 (n=19) | 39.5 / 33.3 (n=6) | 14.3 / 0.0 (n=1) |

### Por forma da consulta compilada (só métodos que compilam)

| método | branching | chain | cyclic | disconnected | intersection | single-hop |
|---|---|---|---|---|---|---|
| witnessrag | 51.6 (n=6) | 53.5 (n=21) | 55.0 (n=3) | 39.5 (n=12) | 62.4 (n=32) | 52.7 (n=28) |

### Resposta do executor antes do leitor

| método | n | EM estrutural | contexto com testemunha completa |
|---|---|---|---|
| witnessrag | 102 | 2.0 | 25.5 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| witnessrag | 102 | 25.5 | 7.8 | 26 | 0 | 0 | 42 | 34 | 0 | 220 | 23.2 |
...
| método | motivo | n |
|---|---|---|
| witnessrag | wrong_answer_type | 95 |
| witnessrag | wrong_identity | 45 |
...
Indexação compartilhada: 112.09260012209415 s · {"em_cache": 0, "tokens_prompt": 89768, "chamadas": 100, "tokens_resposta_sem_cache": 34042, "filtradas": 0, "tokens_resposta": 34042, "tokens_prompt_sem_cache": 89768}

Custos de LLM: tokens lógicos e tokens sem cache local. Embeddings não estão contabilizados em tokens; estes números não representam custo financeiro total.

| método | chamadas (consulta) | tokens prompt | tokens resposta | tempo (s) |
|---|---|---|---|---|
| witnessrag | 679 | 2444038 | 41350 | 1145.63 |
